...
fig.savefig("FinanceLearning/Graphs and Gifs/new_graph.png", bbox_inches='tight')
...
fig_sub.savefig("FinanceLearning/Graphs and Gifs/subplot.png", bbox_inches = 'tight')
...
fig3_d.savefig("FinanceLearning/Graphs and Gifs/3d_surface.png", bbox_inches = 'tight')
